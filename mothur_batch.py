...
def mothur_batch(project_name, standard, max_len, pre_clust_val, design, sub_samp_size):
    ...
    print("Aligns Samples to Generated File: (12/38)")
    ...
    print("Removed Seqs Outside of Alignment Range: (14/38)")
    ...
    m.unique.seqs(fasta=project_name+".trim.contigs.good.unique.good.filter.fasta",
                  count=project_name+".trim.contigs.good.count_table")
    print("Removed Duplicate Seqs: (16/38)")
    ...
    print("Removed Detected Chimeras: (19/38)")
    ...
    print("Sub Sampling to : " + str(sub_samp_size))
    ...
    print("Renamed Subsampled Seqs: (27/38)")
    ...
    print("Renamed Count Table: (28/38)")
    ...
    print("Renamed Taxonomy File: (29/38)")
    ...
    print("Summarized Taxonomy: (30/38)")
    ...
    print("Binned Sequences to OTU: (31/38)")
    ...
    print("Determined if Groups are Significantly Different: (37/38)")
    # OTUs sig different between groups
    m.metastats(shared=project_name +
                ".final.subs.opti_mcc.shared", design=design)
    print("Determined if OTU are Different Between Groups: (38/38)")
